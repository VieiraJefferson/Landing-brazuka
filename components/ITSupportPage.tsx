  ...
  return (
    <main className="bg-[#151513] text-[#FDFDFD] overflow-x-hidden w-full max-w-full">
      ...
      <section 
        ...
        style={{
          backgroundImage: 'url(https://res.cloudinary.com/dpilz4p6g/image/upload/v1763657437/ChatGPT_Image_20_11_2025_16_50_05_l8t0aq.png)',
      ...
      >
        ...
        >
          <h1 className="text-5xl md:text-6xl font-bold mb-6">{t("itSupportTitle")}</h1>
